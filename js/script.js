    ...
    new MenuItem(
        ...
        function postData(form){
            form.addEventListener('submit',(e) =>{
                e.preventDefault(); //устранение стандартного поведения браузера(страница не перезагружалась)

                const statusMessage = document.createElement('div');
                statusMessage.classList.add('status');
                statusMessage.textContent = message.loading;//отправка сообщений о загрузке
